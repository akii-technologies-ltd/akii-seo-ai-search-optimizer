...
**Install directly from this GitHub repo (works today):**
...
**Or, once approved in the [Anthropic community marketplace](https://github.com/anthropics/claude-plugins-community):**
